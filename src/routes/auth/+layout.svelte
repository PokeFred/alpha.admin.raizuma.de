<script lang="ts">
    import AuthHeaderButton from "$components/AuthHeaderButton.svelte"
</script>

<div class="top-0 left-0 w-full h-full bg-slate-900 flex justify-center items-center absolute">
